(** Domain-event handler for {!Account.Portfolio.reservation_released}.
...
val to_integration_event :
  Account.Portfolio.reservation_released -> Reservation_released.t
...
val handle :
  ...
  Account.Portfolio.reservation_released ->
  unit
