(** Mirror of {!Broker_integration_events.Order_leg_filled_integration_event.t}
    — the broker BC's outbound per-leg fill IE, consumed by
    {!Order_leg_filled_integration_event_handler} to feed
    {!Apply_placement_leg_fill_command_workflow}. *)
