...
let leg_notional mark (tp : Shared.Target_position.t) =
...
let clip_per_instrument ~max_notional ~mark (tp : Shared.Target_position.t) :
...
let clip
    ...
    (proposal : Shared.Target_proposal.t) : Shared.Target_proposal.t =
