(** PM-side inbound DTO mirror of an instrument view model.
    ...
    {!Portfolio_management_view_models.Instrument_view_model} (PM's
    own outbound projection) so that the inbound and outbound sides
    of the wire can evolve their schemas independently.
