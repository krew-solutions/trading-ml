/*
  Generated by atdts from type definitions in 'cluster_view_model.atd'.
...
export function writeT(x: T, context: any = x): any {
  return {
    'price': _atd_write_required_field('T', 'price', _atd_write_string, x.price, x),
    'buy_volume': _atd_write_required_field('T', 'buy_volume', _atd_write_string, x.buy_volume, x),
    'sell_volume': _atd_write_required_field('T', 'sell_volume', _atd_write_string, x.sell_volume, x),
    'indeterminate_volume': _atd_write_required_field('T', 'indeterminate_volume', _atd_write_string, x.indeterminate_volume, x),
  };
}

export function readT(x: any, context: any = x): T {
  return {
    price: _atd_read_required_field('T', 'price', _atd_read_string, x['price'], x),
    buy_volume: _atd_read_required_field('T', 'buy_volume', _atd_read_string, x['buy_volume'], x),
    sell_volume: _atd_read_required_field('T', 'sell_volume', _atd_read_string, x['sell_volume'], x),
    indeterminate_volume: _atd_read_required_field('T', 'indeterminate_volume', _atd_read_string, x['indeterminate_volume'], x),
  };
}
