/*
  Generated by atdts from type definitions in 'footprint_completed_integration_event.atd'.
...
import { type T as InstrumentViewModel } from "./instrument_view_model"
export { type InstrumentViewModel }

import { type T as ClusterViewModel } from "./cluster_view_model"
...
import { writeT as writeInstrumentViewModel } from "./instrument_view_model"
export { writeInstrumentViewModel }

import { readT as readInstrumentViewModel } from "./instrument_view_model"
export { readInstrumentViewModel }

import { writeT as writeClusterViewModel } from "./cluster_view_model"
export { writeClusterViewModel }

import { readT as readClusterViewModel } from "./cluster_view_model"
export { readClusterViewModel }

export function writeT(x: T, context: any = x): any {
  return {
    'instrument': _atd_write_required_field('T', 'instrument', writeInstrumentViewModel, x.instrument, x),
    'timeframe': _atd_write_required_field('T', 'timeframe', _atd_write_string, x.timeframe, x),
    'open_ts': _atd_write_required_field('T', 'open_ts', _atd_write_string, x.open_ts, x),
    'open_price': _atd_write_required_field('T', 'open_price', _atd_write_string, x.open_price, x),
    'high': _atd_write_required_field('T', 'high', _atd_write_string, x.high, x),
    'low': _atd_write_required_field('T', 'low', _atd_write_string, x.low, x),
    'close': _atd_write_required_field('T', 'close', _atd_write_string, x.close, x),
    'volume': _atd_write_required_field('T', 'volume', _atd_write_string, x.volume, x),
    'delta': _atd_write_required_field('T', 'delta', _atd_write_string, x.delta, x),
    'poc_price': _atd_write_required_field('T', 'poc_price', _atd_write_string, x.poc_price, x),
    'clusters': _atd_write_required_field('T', 'clusters', _atd_write_array(writeClusterViewModel), x.clusters, x),
  };
}

export function readT(x: any, context: any = x): T {
  return {
    instrument: _atd_read_required_field('T', 'instrument', readInstrumentViewModel, x['instrument'], x),
    timeframe: _atd_read_required_field('T', 'timeframe', _atd_read_string, x['timeframe'], x),
    open_ts: _atd_read_required_field('T', 'open_ts', _atd_read_string, x['open_ts'], x),
    open_price: _atd_read_required_field('T', 'open_price', _atd_read_string, x['open_price'], x),
    high: _atd_read_required_field('T', 'high', _atd_read_string, x['high'], x),
    low: _atd_read_required_field('T', 'low', _atd_read_string, x['low'], x),
    close: _atd_read_required_field('T', 'close', _atd_read_string, x['close'], x),
    volume: _atd_read_required_field('T', 'volume', _atd_read_string, x['volume'], x),
    delta: _atd_read_required_field('T', 'delta', _atd_read_string, x['delta'], x),
    poc_price: _atd_read_required_field('T', 'poc_price', _atd_read_string, x['poc_price'], x),
    clusters: _atd_read_required_field('T', 'clusters', _atd_read_array(readClusterViewModel), x['clusters'], x),
  };
}
