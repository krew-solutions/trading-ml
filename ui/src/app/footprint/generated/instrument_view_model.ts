/*
  Generated by atdts from type definitions in 'instrument_view_model.atd'.
...
export function writeT(x: T, context: any = x): any {
  return {
    'ticker': _atd_write_required_field('T', 'ticker', _atd_write_string, x.ticker, x),
    'venue': _atd_write_required_field('T', 'venue', _atd_write_string, x.venue, x),
    'isin': _atd_write_optional_field(_atd_write_string, x.isin, x),
    'board': _atd_write_optional_field(_atd_write_string, x.board, x),
  };
}

export function readT(x: any, context: any = x): T {
  return {
    ticker: _atd_read_required_field('T', 'ticker', _atd_read_string, x['ticker'], x),
    venue: _atd_read_required_field('T', 'venue', _atd_read_string, x['venue'], x),
    isin: _atd_read_optional_field(_atd_read_string, x['isin'], x),
    board: _atd_read_optional_field(_atd_read_string, x['board'], x),
  };
}
